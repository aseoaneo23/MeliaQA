...
Background:
    ...
    # REMINDER (La web carga con muchas peticion el buffer y la memoria se poe a 90%, por eso es mejor pasarlos indivisualmente comentando los examples y descomentand olos otros)
